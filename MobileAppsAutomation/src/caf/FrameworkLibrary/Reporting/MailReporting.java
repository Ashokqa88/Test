package caf.FrameworkLibrary.Reporting;
...
import caf.FrameworkLibrary.CapDriver;
...
public class MailReporting extends CapDriver {
	...
	public void sendMail(String s) throws Exception {
		...
		try {
			...
			message.setSubject("Mobile Apps Automation Suite " + dateWithTime);

...
public class CapDriver extends DataConfig {
	...
	public void clickOptional(String locator_Android, String locator_iOS) throws IOException {
		String locator=super.locatorByOS(locator_Android, locator_iOS);
		try{
			waitForElementPresence(locator_Android,locator_iOS, 30).click();
	} catch (Exception e) {
		System.out.println("Locator not available. Locator is :" + locator + " and exception is :" + e);
	}
	}
	public void clickOptional(String locator) throws IOException {
		try{
			waitForElementPresence(locator, 30).click();
	} catch (Exception e) {
		System.out.println("Locator not available. Locator is :" + locator + " and exception is :" + e);
	}
	}
